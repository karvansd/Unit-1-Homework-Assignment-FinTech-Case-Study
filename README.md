...
* What solution does this company offer that their competitors do not or cannot offer? (What is the unfair advantage they utilize?)
  ...
  - Two key capabilities of nanopay that power its product offerings and value proposition:
    - Store of value: Nanopay offers a digital cash mechanism. The digital cash is equal to fiat currency enabling the instantaneous and secure transactions, as well as guaranteed value and usability for its users [[1]](#1)[[2]](#2).
